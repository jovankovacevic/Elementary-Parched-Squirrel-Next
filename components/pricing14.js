          ...
          <div className="pricing14-section-title">
            ...
            <div className="pricing14-content">
              <h2>
                {props.heading1 ?? (
                  <Fragment>
                    <h2 className="pricing14-text179 thq-heading-2">
                      Pricing plan
                    </h2>
                  </Fragment>
                )}
                ...
                <div className="pricing14-price10">
                  <div className="pricing14-price11">
                    ...
                    <p>
                      {props.plan1Yearly ?? (
                        <Fragment>
                          <p className="pricing14-text184 thq-body-large">
                            $999/year
                          </p>
                        </Fragment>
                      )}
                ...
                <div className="pricing14-price12">
                  <div className="pricing14-price13">
                    <p>
                      {props.plan2 ?? (
                        <Fragment>
                          <p className="pricing14-text193 thq-body-large">
                            Business plan
                          </p>
                        </Fragment>
                      )}
                    ...
                    <h3>
                      {props.plan2Price ?? (
                        <Fragment>
                          <h3 className="pricing14-text164 thq-heading-3">
                            $29/mo
                          </h3>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing14-list2">
                    <div className="pricing14-list-item13">
                      ...
                      <span>
                        {props.plan2Feature1 ?? (
                          <Fragment>
                            <span className="pricing14-text203 thq-body-small">
                ...
                <div className="pricing14-price14">
                  <div className="pricing14-price15">
                    <p>
                      {props.plan3 ?? (
                        <Fragment>
                          <p className="pricing14-text156 thq-body-large">
                            Enterprise plan
                          </p>
                        </Fragment>
                      )}
                    ...
                    <h3>
                      {props.plan3Price ?? (
                        <Fragment>
                          <h3 className="pricing14-text181 thq-heading-3">
                            $49/mo
                          </h3>
                        </Fragment>
                      )}
                    ...
                    <p>
                      {props.plan3Yearly ?? (
                        <Fragment>
                          <p className="pricing14-text163 thq-body-large">
                            or $499 yearly
                          </p>
                        </Fragment>
                      )}
                ...
                <div className="pricing14-price16">
                  <div className="pricing14-price17">
                    <span>
                      {props.plan11 ?? (
                        <Fragment>
                          <span className="pricing14-text205 thq-body-large">
                            Basic plan
                          </span>
                        </Fragment>
                      )}
                    ...
                    <h3>
                      {props.plan1Price1 ?? (
                        <Fragment>
                          <h3 className="pricing14-text174 thq-heading-3">
                            $200/yr
                          </h3>
                        </Fragment>
                      )}
                ...
                <div className="pricing14-price18">
                  <div className="pricing14-price19">
                    ...
                    <h3>
                      {props.plan2Price1 ?? (
                        <Fragment>
                          <h3 className="pricing14-text199 thq-heading-3">
                            $299/yr
                          </h3>
                        </Fragment>
                      )}
                    ...
                    <span>
                      {props.plan2Yearly1 ?? (
                        <Fragment>
                          <span className="pricing14-text161 thq-body-large">
                            or $29 monthly
                          </span>
                        </Fragment>
                      )}
